...
public:
    ...
    Result
    GetAccountNotificationSettings(Out<s32> out_count,
                                   OutArray<AccountNotificationSettings, BufferAttr_HipcMapAlias>
                                       out_account_notification_settings);
    Result
    SetAccountNotificationSettings(InArray<AccountNotificationSettings, BufferAttr_HipcMapAlias>
    ...
    Result
    GetPushNotificationActivityModeOnSleep(Out<s32> out_push_notification_activity_mode_on_sleep);
    ...
    Result
    GetAccountUserSettings(Out<u32> out_count,
