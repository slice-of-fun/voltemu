...
Result
IReadOnlyApplicationRecordInterface::HasApplicationRecord(Out<bool> out_has_application_record,
                                                          u64 program_id)
{
...
Result
IReadOnlyApplicationRecordInterface::IsDataCorruptedResult(Out<bool> out_is_data_corrupted_result,
                                                           Result result)
{
