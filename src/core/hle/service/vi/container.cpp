...
Result Container::GetBinderDriver(std::shared_ptr<Nvnflinger::IHOSBinderDriver>* out_binder_driver)
{
...
Result
Container::GetLayerProducerHandle(std::shared_ptr<android::BufferQueueProducer>* out_producer,
                                  u64 layer_id)
{
    std::scoped_lock lk{m_lock};
