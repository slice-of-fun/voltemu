...
Result
IDisplayController::GetCallerAppletCaptureImageEx(Out<bool> out_was_written,
...
Result
IDisplayController::AcquireLastForegroundCaptureSharedBuffer(Out<bool> out_was_written,
...
Result IDisplayController::AcquireCallerAppletCaptureSharedBuffer(Out<bool> out_was_written,
                                                                  Out<s32> out_fbshare_layer_index)
{
    LOG_WARNING(Service_AM, "(STUBBED) called");
    R_RETURN(applet->display_layer_manager.WriteAppletCaptureBuffer(out_was_written,
...
Result
IDisplayController::AcquireLastApplicationCaptureSharedBuffer(Out<bool> out_was_written,
                                                              Out<s32> out_fbshare_layer_index)
{
    LOG_WARNING(Service_AM, "(STUBBED) called");
    R_RETURN(applet->display_layer_manager.WriteAppletCaptureBuffer(out_was_written,
