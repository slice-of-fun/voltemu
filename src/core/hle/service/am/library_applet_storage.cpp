...
public:
    ...
    s64 GetSize() override { return m_data.size(); }

    Kernel::KTransferMemory* GetHandle() override { return nullptr; }
...
public:
    ...
    s64 GetSize() override { return m_size; }
...
public:
    ...
    Kernel::KTransferMemory* GetHandle() override { return m_trmem; }
};
