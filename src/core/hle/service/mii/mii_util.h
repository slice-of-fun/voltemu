...
public:
    ...
    static Common::UUID MakeCreateId() { return Common::UUID::MakeRandomRFC4122V4(); }
    ...
    template<typename T> static T GetRandomValue(T min, T max)
    {
    ...
    template<typename T> static T GetRandomValue(T max) { return GetRandomValue<T>({}, max); }
