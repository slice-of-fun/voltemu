...
public:
    ...
    void AllowDeviceMappingOfExecPages() { m_page_table.AllowDeviceMappingOfExecPages(); }
    ...
    size_t GetNumGuardPages() const { return m_page_table.GetNumGuardPages(); }

    KScopedLightLock AcquireDeviceMapLock() { return m_page_table.AcquireDeviceMapLock(); }
    ...
    Result SetProcessMemoryPermission(KProcessAddress addr, size_t size, Svc::MemoryPermission perm)
    {
    ...
    Result SetMaxHeapSize(size_t size) { R_RETURN(m_page_table.SetMaxHeapSize(size)); }
    ...
    KProcessAddress GetCodeRegionStart() const { return m_page_table.GetCodeRegionStart(); }
    ...
    size_t GetCodeRegionSize() const { return m_page_table.GetCodeRegionSize(); }
    ...
    u32 GetAddressSpaceWidth() const { return m_page_table.GetAddressSpaceWidth(); }
    ...
    KBlockInfoManager* GetBlockInfoManager() { return m_page_table.GetBlockInfoManager(); }

    KPageTable& GetBasePageTable() { return m_page_table; }

    const KPageTable& GetBasePageTable() const { return m_page_table; }
};
