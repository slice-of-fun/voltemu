...
template<class Derived> class KSlabAllocated {
public:
...
public:
    ...
    static void Free(KernelCore& kernel, Derived* obj) { kernel.SlabHeap<Derived>().Free(obj); }
...
template<typename Derived, typename Base> class KAutoObjectWithSlabHeap : public Base {
...
template<typename Derived, typename Base> class KAutoObjectWithSlabHeapAndContainer : public Base {
