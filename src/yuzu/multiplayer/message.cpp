...
const ConnectionError
    ErrorManager::IP_ADDRESS_NOT_VALID(QT_TR_NOOP("IP is not a valid IPv4 address."));
const ConnectionError
    ErrorManager::PORT_NOT_VALID(QT_TR_NOOP("Port must be a number between 0 to 65535."));
...
const ConnectionError ErrorManager::COULD_NOT_CREATE_ROOM(QT_TR_NOOP(
    "Creating a room failed. Please retry. Restarting Volt Emulator might be necessary."));
...
const ConnectionError
    ErrorManager::LOST_CONNECTION(QT_TR_NOOP("Connection to room lost. Try to reconnect."));
const ConnectionError
    ErrorManager::HOST_KICKED(QT_TR_NOOP("You have been kicked by the room host."));
const ConnectionError
    ErrorManager::IP_COLLISION(QT_TR_NOOP("IP address is already in use. Please choose another."));
