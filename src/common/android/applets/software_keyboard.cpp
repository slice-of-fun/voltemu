...
void InitJNI(JNIEnv* env)
{
    s_software_keyboard_class = reinterpret_cast<jclass>(
        env->NewGlobalRef(env->FindClass("dev/volt_emu/volt/applets/keyboard/SoftwareKeyboard")));
    s_keyboard_config_class = reinterpret_cast<jclass>(env->NewGlobalRef(
        env->FindClass("dev/volt_emu/volt/applets/keyboard/SoftwareKeyboard$KeyboardConfig")));
    s_keyboard_data_class = reinterpret_cast<jclass>(env->NewGlobalRef(
        env->FindClass("dev/volt_emu/volt/applets/keyboard/SoftwareKeyboard$KeyboardData")));

    s_swkbd_execute_normal = env->GetStaticMethodID(
        s_software_keyboard_class, "executeNormal",
        "(Ldev/volt_emu/volt/applets/keyboard/SoftwareKeyboard$KeyboardConfig;)Ldev/volt_emu/volt/"
    ...
    s_swkbd_execute_inline = env->GetStaticMethodID(
        ...
        "(Ldev/volt_emu/volt/applets/keyboard/SoftwareKeyboard$KeyboardConfig;)V");
}
