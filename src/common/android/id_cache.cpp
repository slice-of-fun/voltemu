...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    const jclass native_library_class = env->FindClass("dev/volt_emu/volt/NativeLibrary");
    s_native_library_class = reinterpret_cast<jclass>(env->NewGlobalRef(native_library_class));
    s_disk_cache_progress_class = reinterpret_cast<jclass>(env->NewGlobalRef(
        env->FindClass("dev/volt_emu/volt/disk_shader_cache/DiskShaderCacheProgress")));
    s_load_callback_stage_class = reinterpret_cast<jclass>(env->NewGlobalRef(env->FindClass(
        "dev/volt_emu/volt/disk_shader_cache/DiskShaderCacheProgress$LoadCallbackStage")));

    const jclass game_dir_class = env->FindClass("dev/volt_emu/volt/model/GameDir");
    ...
    const jclass game_class = env->FindClass("dev/volt_emu/volt/model/Game");
    ...
    const jclass overlay_control_data_class =
        env->FindClass("dev/volt_emu/volt/overlay/model/OverlayControlData");
    ...
    const jclass patch_class = env->FindClass("dev/volt_emu/volt/model/Patch");
    ...
    const jclass player_input_class =
        env->FindClass("dev/volt_emu/volt/features/input/model/PlayerInput");
    ...
    const jclass yuzu_input_device_interface =
        env->FindClass("dev/volt_emu/volt/features/input/YuzuInputDevice");
