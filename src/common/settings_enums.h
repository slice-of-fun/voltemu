...
#define ENUM(NAME, ...)                                                                            \
    ...
    template<>                                                                                     \
    inline std::vector<std::pair<std::string_view, NAME>> EnumMetadata<NAME>::Canonicalizations()  \
    {                                                                                              \
...
/// declared here
template<> inline u32 EnumMetadata<AudioEngine>::Index()
{
    return 100;
}
template<> inline AudioEngine EnumMetadata<AudioEngine>::GetFirst()
{
    return AudioEngine::Auto;
}
template<> inline AudioEngine EnumMetadata<AudioEngine>::GetLast()
{
...
template<typename Type> inline std::string_view CanonicalizeEnum(Type id)
{
