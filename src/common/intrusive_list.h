...
public:
    ...
    constexpr bool IsLinked() const { return m_next != this; }
...
private:
    ...
    constexpr void Unlink() { this->Unlink(m_next); }
    ...
    constexpr IntrusiveListNode* GetPrev() { return m_prev; }

    constexpr const IntrusiveListNode* GetPrev() const { return m_prev; }

    constexpr IntrusiveListNode* GetNext() { return m_next; }

    constexpr const IntrusiveListNode* GetNext() const { return m_next; }
};
...
public:
    ...
    public:
        ...
        constexpr operator Iterator<true>() const { return Iterator<true>(m_node); }
...
public:
    ...
    // Iterator accessors.
    constexpr iterator begin() { return iterator(m_root_node.GetNext()); }

    constexpr const_iterator begin() const { return const_iterator(m_root_node.GetNext()); }

    constexpr iterator end() { return iterator(std::addressof(m_root_node)); }

    constexpr const_iterator end() const { return const_iterator(std::addressof(m_root_node)); }
    ...
    // Content management.
    constexpr bool empty() const { return !m_root_node.IsLinked(); }
    ...
    constexpr reference back() { return *m_root_node.GetPrev(); }

    constexpr const_reference back() const { return *m_root_node.GetPrev(); }

    constexpr reference front() { return *m_root_node.GetNext(); }

    constexpr const_reference front() const { return *m_root_node.GetNext(); }

    constexpr void push_back(reference node) { m_root_node.LinkPrev(std::addressof(node)); }

    constexpr void push_front(reference node) { m_root_node.LinkNext(std::addressof(node)); }

    constexpr void pop_back() { m_root_node.GetPrev()->Unlink(); }

    constexpr void pop_front() { m_root_node.GetNext()->Unlink(); }
...
template<class T, class Traits> class IntrusiveList {
...
public:
    ...
    private:
        ...
        constexpr ImplIterator GetImplIterator() const { return m_iterator; }
    ...
    public:
        ...
        constexpr reference operator*() const { return Traits::GetParent(*m_iterator); }
        ...
        constexpr operator Iterator<true>() const { return Iterator<true>(m_iterator); }
    };

private:
    static constexpr IntrusiveListNode& GetNode(reference ref) { return Traits::GetNode(ref); }
...
public:
    ...
    // Iterator accessors.
    constexpr iterator begin() { return iterator(m_impl.begin()); }

    constexpr const_iterator begin() const { return const_iterator(m_impl.begin()); }

    constexpr iterator end() { return iterator(m_impl.end()); }

    constexpr const_iterator end() const { return const_iterator(m_impl.end()); }

    constexpr const_iterator cbegin() const { return this->begin(); }

    constexpr const_iterator cend() const { return this->end(); }

    constexpr reverse_iterator rbegin() { return reverse_iterator(this->end()); }

    constexpr const_reverse_iterator rbegin() const { return const_reverse_iterator(this->end()); }

    constexpr reverse_iterator rend() { return reverse_iterator(this->begin()); }

    constexpr const_reverse_iterator rend() const { return const_reverse_iterator(this->begin()); }

    constexpr const_reverse_iterator crbegin() const { return this->rbegin(); }

    constexpr const_reverse_iterator crend() const { return this->rend(); }

    constexpr iterator iterator_to(reference v) { return iterator(m_impl.iterator_to(GetNode(v))); }
    ...
    constexpr reference back() { return GetParent(m_impl.back()); }

    constexpr const_reference back() const { return GetParent(m_impl.back()); }

    constexpr reference front() { return GetParent(m_impl.front()); }

    constexpr const_reference front() const { return GetParent(m_impl.front()); }

    constexpr void push_back(reference ref) { m_impl.push_back(GetNode(ref)); }

    constexpr void push_front(reference ref) { m_impl.push_front(GetNode(ref)); }

    constexpr void pop_back() { m_impl.pop_back(); }

    constexpr void pop_front() { m_impl.pop_front(); }
...
template<auto T, class Derived = Common::impl::GetParentType<T>> class IntrusiveListMemberTraits;
...
private:
    ...
    static constexpr IntrusiveListNode& GetNode(Derived& parent) { return parent.*Member; }
...
template<class Derived> class IntrusiveListBaseNode : public IntrusiveListNode {
};

template<class Derived> class IntrusiveListBaseTraits {
public:
