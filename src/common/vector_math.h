...
public:
    ...
    template<typename T2> [[nodiscard]] constexpr Vec2<T2> Cast() const
    {
    ...
    template<typename V> constexpr Vec2& operator*=(const V& f)
    {
        *this = *this * f;
        return *this;
    }
...
template<> inline float Vec2<float>::Normalize()
{
    float length = Length();
    *this /= length;
    return length;
...
public:
    ...
    template<typename T2> [[nodiscard]] constexpr Vec3<T2> Cast() const
    {
    ...
    template<typename V> constexpr Vec3& operator*=(const V& f)
    {
        *this = *this * f;
        return *this;
    }
...
template<> inline float Vec3<float>::Length() const
{
    return std::sqrt(x * x + y * y + z * z);
}

template<> inline Vec3<float> Vec3<float>::Normalized() const
{
    return *this / Length();
}

template<> inline float Vec3<float>::Normalize()
{
    float length = Length();
    *this /= length;
    return length;
...
public:
    ...
    constexpr Vec4(const T& x_, const T& y_, const T& z_, const T& w_) : x(x_), y(y_), z(z_), w(w_)
    {
    }

    template<typename T2> [[nodiscard]] constexpr Vec4<T2> Cast() const
    {
    ...
    template<typename V> constexpr Vec4& operator*=(const V& f)
    {
        *this = *this * f;
        return *this;
    }
...
template<> [[nodiscard]] inline float Dot(const Vec4<float>& a, const Vec4<float>& b)
{
#ifdef __ARM_NEON
...
[[nodiscard]] constexpr decltype((X{} * int{} + X{} * int{}) / base)
LerpInt(const X& begin, const X& end, const int t)
{
...
template<typename T> [[nodiscard]] constexpr Vec2<T> MakeVec(const T& x, const T& y)
{
    return Vec2<T>{x, y};
}

template<typename T> [[nodiscard]] constexpr Vec3<T> MakeVec(const T& x, const T& y, const T& z)
{
    return Vec3<T>{x, y, z};
}
...
template<typename T> [[nodiscard]] constexpr Vec3<T> MakeVec(const Vec2<T>& xy, const T& z)
{
    return MakeVec(xy[0], xy[1], z);
}

template<typename T> [[nodiscard]] constexpr Vec3<T> MakeVec(const T& x, const Vec2<T>& yz)
{
...
template<typename T> [[nodiscard]] constexpr Vec4<T> MakeVec(const Vec2<T>& xy, const Vec2<T>& zw)
{
    return MakeVec(xy[0], xy[1], zw[0], zw[1]);
}

template<typename T> [[nodiscard]] constexpr Vec4<T> MakeVec(const Vec3<T>& xyz, const T& w)
{
    return MakeVec(xyz[0], xyz[1], xyz[2], w);
}

template<typename T> [[nodiscard]] constexpr Vec4<T> MakeVec(const T& x, const Vec3<T>& yzw)
{
