...
public:
    ...
    virtual bool HasUnsyncedQueries() const { return false; }
    ...
    u64 GetDependenceMask() const { return dependence_mask; }

    u64 GetDependentMask() const { return dependent_mask; }

    u64 GetAmendValue() const { return amend_value; }

    void SetAccumulationValue(u64 new_value) { accumulation_value = new_value; }
...
template<typename QueryType> class SimpleStreamer : public StreamerInterface {
public:
