...
void HLE_DrawArraysIndirect::Execute(Engines::Maxwell3D& maxwell3d, std::span<const u32> parameters,
...
void HLE_DrawArraysIndirect::Fallback(Engines::Maxwell3D& maxwell3d,
...
void HLE_DrawIndexedIndirect::Execute(Engines::Maxwell3D& maxwell3d,
...
void HLE_DrawIndexedIndirect::Fallback(Engines::Maxwell3D& maxwell3d,
                                       std::span<const u32> parameters)
{
    maxwell3d.RefreshParameters();
    const u32 instance_count = (maxwell3d.GetRegisterValue(0xD1B) & parameters[2]);
...
void HLE_MultiLayerClear::Execute(Engines::Maxwell3D& maxwell3d, std::span<const u32> parameters,
                                  [[maybe_unused]] u32 method)
{
    maxwell3d.RefreshParameters();
...
void HLE_MultiDrawIndexedIndirectCount::Execute(Engines::Maxwell3D& maxwell3d,
                                                std::span<const u32> parameters,
                                                [[maybe_unused]] u32 method)
{
    ...
    maxwell3d.SetHLEReplacementAttributeType(0, 0x640,
                                             Maxwell3D::HLEReplacementAttributeType::BaseVertex);
    maxwell3d.SetHLEReplacementAttributeType(0, 0x644,
                                             Maxwell3D::HLEReplacementAttributeType::BaseInstance);
...
void HLE_MultiDrawIndexedIndirectCount::Fallback(Engines::Maxwell3D& maxwell3d,
                                                 std::span<const u32> parameters)
{
    SCOPE_EXIT
    {
...
void HLE_DrawIndirectByteCount::Execute(Engines::Maxwell3D& maxwell3d,
                                        std::span<const u32> parameters,
                                        [[maybe_unused]] u32 method)
{
...
void HLE_DrawIndirectByteCount::Fallback(Engines::Maxwell3D& maxwell3d,
                                         std::span<const u32> parameters)
{
    maxwell3d.RefreshParameters();
    maxwell3d.regs.draw.begin = parameters[0];
...
void HLE_C713C83D8F63CCF3::Execute(Engines::Maxwell3D& maxwell3d, std::span<const u32> parameters,
                                   [[maybe_unused]] u32 method)
{
    maxwell3d.RefreshParameters();
...
void HLE_D7333D26E0A93EDE::Execute(Engines::Maxwell3D& maxwell3d, std::span<const u32> parameters,
                                   [[maybe_unused]] u32 method)
{
    maxwell3d.RefreshParameters();
...
void HLE_BindShader::Execute(Engines::Maxwell3D& maxwell3d, std::span<const u32> parameters,
                             [[maybe_unused]] u32 method)
{
    maxwell3d.RefreshParameters();
...
void HLE_SetRasterBoundingBox::Execute(Engines::Maxwell3D& maxwell3d,
                                       std::span<const u32> parameters, [[maybe_unused]] u32 method)
{
    maxwell3d.RefreshParameters();
...
void HLE_ClearConstBuffer::Execute(Engines::Maxwell3D& maxwell3d, std::span<const u32> parameters,
                                   [[maybe_unused]] u32 method)
{
...
void HLE_ClearMemory::Execute(Engines::Maxwell3D& maxwell3d, std::span<const u32> parameters,
                              [[maybe_unused]] u32 method)
{
    maxwell3d.RefreshParameters();
    ...
    maxwell3d.CallMultiMethod(size_t(MAXWELL3D_REG_INDEX(inline_data)), zero_memory.data(),
                              needed_memory, needed_memory);
}
void HLE_TransformFeedbackSetup::Execute(Engines::Maxwell3D& maxwell3d,
                                         std::span<const u32> parameters,
                                         [[maybe_unused]] u32 method)
{
    maxwell3d.RefreshParameters();
    ...
    regs.upload.dest.address_low = parameters[1];
    maxwell3d.CallMethod(size_t(MAXWELL3D_REG_INDEX(launch_dma)), 0x1011, true);
    maxwell3d.CallMethod(size_t(MAXWELL3D_REG_INDEX(inline_data)),
...
void MacroInterpreterImpl::Execute(Engines::Maxwell3D& maxwell3d, std::span<const u32> params,
                                   u32 method)
{
    Reset();
...
bool MacroInterpreterImpl::Step(Engines::Maxwell3D& maxwell3d, bool is_delay_slot)
{
    ...
    case Macro::Operation::AddImmediate: {
        ProcessResult(maxwell3d, opcode.result_operation, opcode.dst,
...
/// necessary).
void MacroInterpreterImpl::ProcessResult(Engines::Maxwell3D& maxwell3d,
...
void MacroJITx64Impl::Execute(Engines::Maxwell3D& maxwell3d, std::span<const u32> parameters,
                              u32 method)
{
...
static void MacroJIT_SendThunk(Engines::Maxwell3D* maxwell3d, Macro::MethodAddress method_address,
                               u32 value)
{
    maxwell3d->CallMethod(method_address.address, value, true);
}
...
{
    const auto base_dir{Common::FS::GetVoltPath(Common::FS::VoltPath::DumpDir)};
