...
Use this guide when you want to use the Steam Deck's native gyro functionality for motion controls in Volt.
...
5. Navigate to the following directory to see you controller configuration: `/home/deck/.config/Volt`
